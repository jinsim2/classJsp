...
<body>
	<div align="center">
		...
		<!-- jsp09_jdbc/JdbcConnect1 클래스 <-> "JdbcConnect1" 서블릿 매핑 -->
		<!-- jsp09_jdbc/JdbcConnect2 클래스 <-> "JdbcConnect2" 서블릿 매핑 -->
		...
		<hr>
		<h3><a href="JdbcConnect3_INSERT2_Form">JDBC 연동 3&4단계 - INSERT(form)</a></h3> 
	</div>
</body>
</html>