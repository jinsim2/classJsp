...
<body>
	...
	(http://localhost:8088/ClassJsp/jsp06_attribute_scope/attributeScopeTest2.jsp)
	=> pageContext 객체의 속성값은 현재 페이지를 벗어났으므로 null 값이 출력됨
	=> reqeust 객체의 속성값은 새로운 요청이 발생했으므로 null 값이 출력됨
	=> session 객체의 속성값은 세션이 유지되므로 저장된 속성값이 유지(출력)됨
	=> application 객체의 속성값은 서버가 동작중이므로 저장된 속성값이 유지(출력)됨
	====================================================================================
	웹브라우저 완전히 종료 후 새로 실행하여 attributeScopeTest2.jsp 페이지에 접근 시
	(http://localhost:8088/ClassJsp/jsp06_attribute_scope/attributeScopeTest2.jsp)
