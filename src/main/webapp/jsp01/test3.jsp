...
<body>
	...
	- 자바의 System.out.print() 메서드와 동일한 문법 구조 사용
	  (단, System.out.print() 메서드는 이클립스 콘솔에 출력되지만,
	   표현식은 웹페이지 내에 출력하므로 JSP의 out.print() 메서드와 동일한 역할 수행)
	--%>
...
// 	public void method3() {} // 컴파일 에러 발생!
	...
	// 스크립틀릿 내에서 브라우저에 출력하면 out.print() 또는 out.println() 메서드 사용
	// => JSP 의 표현식과 동일한 역할을 수행
	out.print("<h3>이 문장은 웹브라우저 화면에 출력됨!</h3>");
	out.print(str3);
	%>
	
	<%-- 로컬 변수는 반드시 변수 선언 위치보다 아래쪽(뒤)에서만 접근 가능 --%>
	<h3>로컬변수 str3 = <%=str3 %></h3>
