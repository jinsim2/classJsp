...
<%-- 	<jsp:include page="includePro.jsp?paramValue=Parameter Value"></jsp:include> --%>

	<%-- pageContext.include() 메서드 호출 시 URL 뒤에 파라미터 연결 가능 --%>
<%-- 	<%pageContext.include("includePro.jsp?paramValue=Parameter Value"); %> --%>
...
<%-- 	<%@ include="includePro.jsp?paramValue=Parameter Value" %> --%>
