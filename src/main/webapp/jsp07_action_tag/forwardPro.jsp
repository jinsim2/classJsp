...
<body>
	...
	<%
	// forwardForm.jsp 페이지에서 전달받은 파라미터를 가져와서 변수에 저장 후 출력
	...
	=> Dispatch(디스패치) 방식의 포워딩을 수행하므로
	   주소표시줄의 주소(URL)가 반영되지 않고, request 객체도 유지됨
	=> 만약, 포워딩 과정에서 추가적인 파라미터 전달이 필요한 경우
...
<%-- 	</jsp:forward> --%>
	...
	<jsp:forward page="forwardPro2.jsp?paramValue1=forward 액션태그의 param 태그 데이터&paramValue2=<%=age2 %>"></jsp:forward>
</body>
</html>