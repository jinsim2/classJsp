...
// http://localhost:8080/StudyJsp/JdbcConnectMainServlet 매핑 시
@WebServlet("/JdbcConnect")
// http://localhost:8080/StudyJsp/jsp09_jdbc/JdbcConnectMainServlet 매핑 시
// @WebServlet("jsp09_jdbc/JdbcConnectMainServlet")
...
//		response.sendRedirect("jsp09_jdbc/jdbc_main.jsp");
		...
		// 서브디렉토리 구조가 URL에 포함되어 있으므로 jdbc_main.jsp 파일명만 명시
//		response.sendRedirect("jdbc_main");
		// ----------------------------------------------------------------
		// 2) 디스패치
		//    => 현재 매핑된 URL : http://localhost:8080/StudyJsp/JdbcConnectionMain
